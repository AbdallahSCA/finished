...
if(empty($name) OR empty($email) OR empty($password) OR empty($National_ID) OR empty($phone)  OR empty($country)) {
    die ("There is one or more field is empty");
} else {
    $INSERT_1 = "INSERT INTO `users`(`Name`, `Email`, `Password`,`NationalID` , `phone`, `Country`) VALUES ($name, $email, $password, $National_ID, $phone,$country)";
...
<body>
    ...
    <div class="main_section">
        ...
        <div class="main_section_form">
            <div></div>
            <div>
                <form action="Sign_Up.php" method="post" class="allform" name="Create">
                    <input type="text" placeholder="Enter Your Name" name="username">
                    <br>
                    <input type="text" placeholder="Enter Your National ID" name="ID">
                    <br>
                    ...
                    <br>
                    <!-- <input type="text" placeholder="Enter Your Addrese" name="">
                    <br> -->
                    ...
                    <input type="submit" value="Create!" id="submit_inform">

                    <span class="login">You have acount ? <a href="login.html">Login</a></span>
                </form>
            </div>
        </div>
    </div>
